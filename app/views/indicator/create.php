            ...
            <form action="" method="post" autocomplete="off">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <select id="indicatorTypeId" name="indicatorTypeId" class="form-control" required>
                            ...
                            <?php foreach ($indicatorTypes as $indicatorType): ?>
                                <option value="<?php echo $indicatorType->getId(); ?>"><?php echo htmlspecialchars($indicatorType->getIndicatorTitle()); ?></option>
                            <?php endforeach; ?>
                        </select>
                    </div>
                    <?php endif; ?>
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="indicatorTitle" name="indicatorTitle" required maxlength="250">
                    </div>
                    <div class="form-group">
                        <label for="indicatorDesc">Performans Göstergesi Açıklaması</label>
                        <textarea class="form-control" id="indicatorDesc" name="indicatorDesc" required></textarea>
                    </div>
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="number" step="0.01" class="form-control" id="completed" name="completed" value="0" required>
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <select id="fieldId" name="fieldId" class="form-control" required>
                            ...
                            <?php foreach ($fields as $field): ?>
                                <option value="<?php echo $field->getId(); ?>"><?php echo htmlspecialchars($field->getFieldName()); ?></option>
                            <?php endforeach; ?>
                        </select>
                    </div>
                    <?php endif; ?>
