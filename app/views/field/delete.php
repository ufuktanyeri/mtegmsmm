<?php
$page_title = $title ?? 'SMM Alanı Sil';
$hidePageHeader = true;
ob_start();
?>
    ...
    <div class="container-xl">
        <div class="row g-2 align-items-center">
            ...
            <div class="col-auto ms-auto">
                <div class="btn-list">
                    <a href="<?php echo BASE_URL; ?>index.php?url=field/index" class="btn btn-outline-secondary">
                ...
                <div class="card">
                    ...
                    <div class="card-footer bg-transparent mt-auto">
                        ...
                        <form action="" method="post" class="d-flex gap-2">
                            ...
                            <a href="<?php echo BASE_URL; ?>index.php?url=field/index" class="btn btn-secondary flex-fill">
                                <i class="ti ti-x me-1"></i>
                                Hayır, İptal Et
                            </a>
                        </form>
                        <?php else: ?>
                        <a href="<?php echo BASE_URL; ?>index.php?url=field/index" class="btn btn-secondary w-100">
                            <i class="ti ti-arrow-left me-1"></i>
                            Geri Dön
                        </a>
                        <?php endif; ?>
