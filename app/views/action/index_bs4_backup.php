                        ...
                        foreach ($actions as $action): ?>
                            <tr data-objective-id="<?php echo $action->getObjectiveId(); ?>">
                                ...
                                <td>
                                    ...
                                    <a href="#" data-toggle="modal" data-target="#deleteModal" data-aimid="<?php echo $aimid; ?>" data-id="<?php echo $action->getId(); ?>" data-title="<?php echo htmlspecialchars($action->getActionTitle()); ?>" class="btn btn-danger">Sil</a>
                                </td>
                            </tr>
                        <?php 
                    $lineNumber++;
